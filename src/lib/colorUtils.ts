...
export const THEME_DEFAULTS: Record<'dark' | 'tokyo' | 'light', Record<string, string>> = {
  dark: {
    ...
    secondary: '253 10% 15%',
    secondaryForeground: '250 15% 90%',
    muted: '253 8% 18%',
    mutedForeground: '250 8% 55%',
    accent: '253 8% 18%',
    accentForeground: '250 15% 90%',
    destructive: '0 63% 50%',
  ...
  light: {
    ...
    card: '0 0% 100%',
    cardForeground: '250 30% 10%',
    popover: '0 0% 100%',
    popoverForeground: '250 30% 10%',
    primary: '252 56% 52%',
    primaryForeground: '0 0% 100%',
    secondary: '250 20% 95%',
    secondaryForeground: '250 30% 10%',
    muted: '250 15% 94%',
    mutedForeground: '250 10% 45%',
    accent: '250 15% 94%',
    accentForeground: '250 30% 10%',
    destructive: '0 84% 60%',
    destructiveForeground: '0 0% 100%',
    border: '250 12% 85%',
    input: '250 12% 85%',
