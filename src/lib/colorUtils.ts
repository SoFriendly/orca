...
export const THEME_DEFAULTS: Record<'dark' | 'tokyo' | 'light', Record<string, string>> = {
  dark: {
    background: '255 18% 8%',
    foreground: '255 20% 90%',
    card: '255 15% 11%',
    cardForeground: '255 20% 90%',
    popover: '255 15% 11%',
    popoverForeground: '255 20% 90%',
    primary: '257 66% 48%',
    primaryForeground: '0 0% 100%',
    secondary: '255 12% 14%',
    secondaryForeground: '255 20% 90%',
    muted: '255 10% 16%',
    mutedForeground: '255 10% 55%',
    accent: '268 10% 16%',
    accentForeground: '268 12% 90%',
    destructive: '0 63% 50%',
  ...
  light: {
    background: '257 22% 98%',
    foreground: '257 30% 10%',
    card: '0 0% 100%',
    cardForeground: '257 30% 10%',
    popover: '0 0% 100%',
    popoverForeground: '257 30% 10%',
    primary: '257 66% 48%',
    primaryForeground: '0 0% 100%',
    secondary: '256 22% 95%',
    secondaryForeground: '256 30% 10%',
    muted: '256 16% 94%',
    mutedForeground: '256 12% 45%',
    accent: '268 20% 93%',
    accentForeground: '268 30% 10%',
    destructive: '0 84% 60%',
    destructiveForeground: '0 0% 100%',
    border: '256 14% 85%',
    input: '256 14% 85%',
...
export function generateCustomThemeCSS(colors: CustomThemeColors['colors']): string {
  ...
  --radius: 0.375rem;
  --panel-shadow: 0 2px 8px rgba(0,0,0,0.2), 0 8px 24px rgba(10,0,30,0.35);
  --nav-bg: ${hexToHSL(colors.background)};
  --glass-bg: ${hexToHSL(colors.background)} / 0.82;
  --glass-border: ${hexToHSL(colors.foreground)} / 0.08;
}`;
}
